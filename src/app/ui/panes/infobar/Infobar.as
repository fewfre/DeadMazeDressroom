package app.ui.panes.infobar
{
	...
	public class Infobar extends Sprite
	{
		...
		public static const QUALITY_CLICKED       : String = "quality_clicked"; // FewfEvent<{ pushed:bool }>
		...
		//           ?showFavorites:bool=false, ?showDownload:bool=false, ?showQualityButton:bool=false, ?gridManagement:(bool|{})=false }
		public function Infobar(pData:Object=null) {
			...
			*********************/
			...
			if(pData.showQualityButton) {
				_qualityButton = new PushButton({ x:_downloadButton.x - 43, y:(50-37)*0.5, size:37, obj:new $PoorQualityIcon() }).appendTo(_rightSideTray) as PushButton;
		...
		public function removeInfo() : void {
			...
			if(_qualityButton) _qualityButton.disable().alpha = 0;
		...
		public function updateQualityButton() : void {
			if(_qualityButton && _itemData) _qualityButton.toggle(!!GameAssets.tornStates[_itemData.type], false);
		}
